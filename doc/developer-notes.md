...
Run with the `-testnet` option to run with "play Lightcoin (tLHC)" on the test network, if you
...
([`valgrind.supp`](https://github.com/LightcoinNodes/Lightcoin/blob/master/contrib/valgrind.supp))
...
- BitcoinMiner : Generates Lightcoin (if wallet is enabled).
