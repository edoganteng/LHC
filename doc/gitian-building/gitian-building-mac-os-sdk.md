...
The script [extract-osx-sdk.sh](https://github.com/LightcoinNodes/Lightcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
Lightcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/LightcoinNodes/Lightcoin/blob/master/doc/README_osx.md) for troubleshooting tips.
