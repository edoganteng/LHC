...
This document provides guidelines for internationalization of the Lightcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `Lightcoin_en.ts` remains unchanged.
