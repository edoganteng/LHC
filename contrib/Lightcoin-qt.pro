...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/Lightcoin-cli.cpp \
           src/Lightcoin-tx.cpp \
           src/Lightcoin.cpp \
           src/db.cpp \
           ...
           src/qt/Lightcoin/settings/settingswidget.cpp \
...
RESOURCES += src/qt/Lightcoin.qrc src/qt/Lightcoin_locale.qrc

TRANSLATIONS += src/qt/locale/Lightcoin_bg.ts \
                src/qt/locale/Lightcoin_de.ts \
                src/qt/locale/Lightcoin_en.ts \
                src/qt/locale/Lightcoin_es.ts \
                src/qt/locale/Lightcoin_fi.ts \
                src/qt/locale/Lightcoin_fr.ts \
                src/qt/locale/Lightcoin_it.ts \
                src/qt/locale/Lightcoin_ja.ts \
                src/qt/locale/Lightcoin_pl.ts \
                src/qt/locale/Lightcoin_pt.ts \
                src/qt/locale/Lightcoin_ru.ts \
                src/qt/locale/Lightcoin_sk.ts \
                src/qt/locale/Lightcoin_sv.ts \
                src/qt/locale/Lightcoin_vi.ts \
                src/qt/locale/Lightcoin_zh_CN.ts \
                src/qt/locale/Lightcoin_zh_TW.ts
