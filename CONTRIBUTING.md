...
[Translation Process](https://github.com/LightcoinNodes/Lightcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Lightcoin Core project, and is not to be
confused with overall Lightcoin Network Protocol consensus changes.
...
Where a patchset proposes to change the Lightcoin consensus, it must have been
