#!/usr/bin/env python3
# Copyright (c) 2019 The Lightcoin developers
...
class BudgetProposalTest(LightcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Lightcoin address")
        assert_raises_rpc_error(-5, "Invalid Lightcoin address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 LHC allowed", self.nodes[0].preparebudget,
