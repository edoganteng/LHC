...
from test_framework.Lightcoin_node import LightcoinTestNode
...
class Lightcoin_ColdStakingTest(LightcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(LightcoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 LHC from the pot)
...
if __name__ == '__main__':
    Lightcoin_ColdStakingTest().main()
