...
#ifndef Lightcoin_STAKEINPUT_H
#define Lightcoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IszLHC() const = 0;
    virtual CDataStream GetUniqueness() const = 0;
    virtual bool ContextCheck(int nHeight, uint32_t nTime) = 0;
};


class CLightcointake : public CStakeInput
{
private:
...
public:
    ...
    bool IszLHC() const override { return false; }
