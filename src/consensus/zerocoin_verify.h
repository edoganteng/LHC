...
#ifndef Lightcoin_CONSENSUS_ZEROCOIN_VERIFY_H
#define Lightcoin_CONSENSUS_ZEROCOIN_VERIFY_H
...
bool RecalculateLightcoinupply(int nHeightStart, bool fSkipzLHC = true);
