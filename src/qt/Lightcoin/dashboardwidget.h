...
#include "config/Lightcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalLHC = 0;
    qint64 totalzLHC = 0;
    QList<qreal> valuesLHC;
    QList<qreal> valueszLHC;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(LightcoinGUI* _window);
    ~DashboardWidget();
