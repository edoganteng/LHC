...
#include "qt/Lightcoin/topbar.h"
#include "qt/Lightcoin/forms/ui_topbar.h"
#include "qt/Lightcoin/lockunlock.h"
#include "qt/Lightcoin/qtutils.h"
#include "qt/Lightcoin/receivedialog.h"
#include "qt/Lightcoin/loadingdialog.h"
...
TopBar::TopBar(LightcoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopLHC}, "amount-small-topbar");
    setCssProperty({ui->labelAmountLHC}, "amount-topbar");
    setCssProperty({ui->labelPendingLHC, ui->labelImmatureLHC}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Lightcoin")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // LHC Total
    QString totalLHC = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);

    // LHC
    // Top
    ui->labelAmountTopLHC->setText(totalLHC);
    // Expanded
    ui->labelAmountLHC->setText(totalLHC);
    ui->labelPendingLHC->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureLHC->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
