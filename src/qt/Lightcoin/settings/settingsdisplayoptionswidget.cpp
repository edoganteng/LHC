...
#include "qt/Lightcoin/settings/settingsdisplayoptionswidget.h"
#include "qt/Lightcoin/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(LightcoinGUI* _window, QWidget *parent) :
