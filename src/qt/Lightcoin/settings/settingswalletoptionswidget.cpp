...
#include "qt/Lightcoin/settings/settingswalletoptionswidget.h"
#include "qt/Lightcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/Lightcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(LightcoinGUI* _window, QWidget *parent) :
