...
#include "qt/Lightcoin/settings/settingsbittoolwidget.h"
#include "qt/Lightcoin/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(LightcoinGUI* _window, QWidget *parent) :
