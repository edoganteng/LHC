...
#include "qt/Lightcoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/Lightcoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(LightcoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableLHC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableLHC,
    ...
    connect(ui->pushButton_UnspendableLHC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableLHC);});
    ...
    if (parent)
        connect(parent, &LightcoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
