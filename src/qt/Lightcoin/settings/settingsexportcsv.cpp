...
#include "qt/Lightcoin/settings/settingsexportcsv.h"
#include "qt/Lightcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(LightcoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Lightcoin_tx_csv_export(*.csv)") : tr("Lightcoin_addresses_csv_export(*.csv)"),
                                        nullptr);
