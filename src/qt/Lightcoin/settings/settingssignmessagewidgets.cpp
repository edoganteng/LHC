...
#include "qt/Lightcoin/settings/settingssignmessagewidgets.h"
#include "qt/Lightcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(LightcoinGUI* _window, QWidget *parent) :
