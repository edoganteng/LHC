...
#include "qt/Lightcoin/settings/settingsconsolewidget.h"
#include "qt/Lightcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/Lightcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(LightcoinGUI* _window, QWidget *parent) :
