...
#include "qt/Lightcoin/settings/settingsbackupwallet.h"
#include "qt/Lightcoin/settings/forms/ui_settingsbackupwallet.h"
#include <QFile>
...
#include "qt/Lightcoin/qtutils.h"
SettingsBackupWallet::SettingsBackupWallet(LightcoinGUI* _window, QWidget *parent) :
