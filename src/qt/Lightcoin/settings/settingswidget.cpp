...
#include "qt/Lightcoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(LightcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &LightcoinGUI::openFAQ);
