...
#include "qt/Lightcoin/settings/settingswalletrepairwidget.h"
#include "qt/Lightcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/Lightcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(LightcoinGUI* _window, QWidget *parent) :
