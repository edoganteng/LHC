...
#include "qt/Lightcoin/forms/ui_send.h"
#include "qt/Lightcoin/addnewcontactdialog.h"
#include "qt/Lightcoin/qtutils.h"
#include "qt/Lightcoin/sendchangeaddressdialog.h"
#include "qt/Lightcoin/optionbutton.h"
#include "qt/Lightcoin/sendconfirmdialog.h"
#include "qt/Lightcoin/myaddressrow.h"
#include "qt/Lightcoin/guitransactionsutils.h"
...
SendWidget::SendWidget(LightcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-lhc");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination lhcAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(lhcAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(lhcAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
