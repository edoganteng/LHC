...
#include "qt/Lightcoin/sendcustomfeedialog.h"
#include "qt/Lightcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(LightcoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &LightcoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
