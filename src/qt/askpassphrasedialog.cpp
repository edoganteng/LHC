...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            LightcoinGUI* window = static_cast<LightcoinGUI*>(parentWidget());
...
{
    LightcoinGUI* gui = static_cast<LightcoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<LightcoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Lightcoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your Lightcoin from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
