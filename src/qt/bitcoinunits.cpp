...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(LHC);
    unitlist.append(mLHC);
    unitlist.append(uLHC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case LHC:
        return QString("Lightcoin");
    case mLHC:
        return QString("mLightcoin");
    case uLHC:
        return QString::fromUtf8("uLightcoin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool iszLHC)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool iszLHC)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, iszLHC);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool iszLHC)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, iszLHC));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
