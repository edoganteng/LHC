...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Lightcoin Core"),
     ...
     * override -datadir in the Lightcoin.conf file in the default data directory
     * (to be consistent with Lightcoind behavior)
     */
