...
extern UniValue setzLightcoineed(const JSONRPCRequest& request);
extern UniValue getzLightcoineed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzLHC(const JSONRPCRequest& request);
extern UniValue dzLightcointate(const JSONRPCRequest& request);
