...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"Lightcoin", "listmasternodes", &listmasternodes, true },
        {"Lightcoin", "getmasternodecount", &getmasternodecount, true },
        {"Lightcoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"Lightcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"Lightcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"Lightcoin", "masternodecurrent", &masternodecurrent, true },
        {"Lightcoin", "startmasternode", &startmasternode, true },
        {"Lightcoin", "createmasternodekey", &createmasternodekey, true },
        {"Lightcoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"Lightcoin", "listmasternodeconf", &listmasternodeconf, true },
        {"Lightcoin", "getmasternodestatus", &getmasternodestatus, true },
        {"Lightcoin", "getmasternodewinners", &getmasternodewinners, true },
        {"Lightcoin", "getmasternodescores", &getmasternodescores, true },
        {"Lightcoin", "preparebudget", &preparebudget, true },
        {"Lightcoin", "submitbudget", &submitbudget, true },
        {"Lightcoin", "mnbudgetvote", &mnbudgetvote, true },
        {"Lightcoin", "getbudgetvotes", &getbudgetvotes, true },
        {"Lightcoin", "getnextsuperblock", &getnextsuperblock, true },
        {"Lightcoin", "getbudgetprojection", &getbudgetprojection, true },
        {"Lightcoin", "getbudgetinfo", &getbudgetinfo, true },
        {"Lightcoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"Lightcoin", "mnfinalbudget", &mnfinalbudget, true },
        {"Lightcoin", "checkbudgets", &checkbudgets, true },
        {"Lightcoin", "mnsync", &mnsync, true },
        {"Lightcoin", "spork", &spork, true },
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41473/\n";
}
