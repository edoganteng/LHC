...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Lightcoin Core Lightcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Lightcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Lightcoin transaction") + "\n" +
                               "  Lightcoin-tx [options] -create [commands]   " + _("Create hex-encoded Lightcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Lightcoin transaction
