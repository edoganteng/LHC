...
#ifndef Lightcoin_zLHCWALLET_H
#define Lightcoin_zLHCWALLET_H
...
public:
    ...
    void GenerateDeterministiczLHC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozLHC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
