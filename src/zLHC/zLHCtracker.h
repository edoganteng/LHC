...
#ifndef Lightcoin_zLHCTRACKER_H
#define Lightcoin_zLHCTRACKER_H
...
public:
    CzLHCTracker(CWallet* parent);
    ~CzLHCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLHCWallet* zLHCWallet = NULL);
