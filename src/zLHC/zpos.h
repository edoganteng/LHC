...
#ifndef Lightcoin_LEGACY_ZPOS_H
#define Lightcoin_LEGACY_ZPOS_H

#include "stakeinput.h"
#include "main.h"
#include "txdb.h"

class CLegacyZLightcointake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    CLegacyZLightcointake() {}

    explicit CLegacyZLightcointake(const libzerocoin::CoinSpend& spend);
    bool InitFromTxIn(const CTxIn& txin) override;
    bool IszLHC() const override { return true; }
