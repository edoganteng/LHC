...
{
    const char* pszTimestamp = "Lightcoin";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("000008f8a613bbcc8273a7397ac5af4e86dd9e9f4143ac707b0496c8efc43cba"))
    (1551, uint256S("8b62c856e759ccd835b1995fc4d2faf6d522da96e800a4823cb4eabc62fb7375"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1621838655, // * UNIX timestamp of last checkpoint block
    2835,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1621685265, 1105095, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000003d55aeb50c6d42756e90d12f64ce8641b0c07eb6e90e5f81a823959a266"));
        assert(genesis.hashMerkleRoot == uint256S("609666ef0a1d82f5be4ac37c6feb88c8c01243eec095140f7b1afc11354962b7"));
        ...
        consensus.nMaxMoneyOut = 2147483647 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "048df2c162c6b08e8f237c2d4ab0a987ffc49628dd28574270bc563d5d93cdecfb9a97f0337d122ec26be8e6e2e8735907c41c5e775d05b3fc5da7bbe614b2bd79";
        consensus.strSporkPubKeyOld = "0417a31983e6aac890afa7b963fa49ef6232b081cfce6c7c5865e70814375393321bb4fd403c892a96f7259baf559d0c48e4aa6bec7adbe5290ca6fc7f2a1f3e19";
        consensus.nTime_EnforceNewSporkKey = 1621110906;    //!> August 26, 2019 11:00:00 PM GMT
        consensus.nTime_RejectOldSporkKey = 1621110906;     //!> September 26, 2019 11:00:00 PM GMT
        ...
        // validation by-pass
        consensus.nLightcoinBadBlockTime = 1621685265;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nLightcoinBadBlockBits = 0x1e0ffff0;    // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.emplace_back("Lightcoin1", "104.238.167.59", true);
        vSeeds.emplace_back("Lightcoin2", "192.248.151.83", true);
        vSeeds.emplace_back("Lightcoin3", "95.179.219.26", true);
        vSeeds.emplace_back("Lightcoin4", "104.207.134.157", true);
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "lhcks";
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1615823708, 753343, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000c8bedbab8bc8589270e21e48205fde0612ba157fb0f1459087380ce44a"));
        assert(genesis.hashMerkleRoot == uint256S("609666ef0a1d82f5be4ac37c6feb88c8c01243eec095140f7b1afc11354962b7"));
        ...
        consensus.strSporkPubKey = "048df2c162c6b08e8f237c2d4ab0a987ffc49628dd28574270bc563d5d93cdecfb9a97f0337d122ec26be8e6e2e8735907c41c5e775d05b3fc5da7bbe614b2bd79";
        consensus.strSporkPubKeyOld = "0417a31983e6aac890afa7b963fa49ef6232b081cfce6c7c5865e70814375393321bb4fd403c892a96f7259baf559d0c48e4aa6bec7adbe5290ca6fc7f2a1f3e19";
        consensus.nTime_EnforceNewSporkKey = 1612700585;    //!> August 26, 2019 11:00:00 PM GMT
        consensus.nTime_RejectOldSporkKey = 1612700585;     //!> September 26, 2019 11:00:00 PM GMT
        ...
        // validation by-pass
        consensus.nLightcoinBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nLightcoinBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        ...
        vSeeds.emplace_back("Lightcoin1", "167.99.138.17", true);
        ...
        // Testnet Lightcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Lightcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Lightcoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "lhcktestsapling";
